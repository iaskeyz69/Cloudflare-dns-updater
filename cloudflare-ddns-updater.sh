...
auth_email=""              # The email used to login to 'https://dash.cloudflare.com'
auth_method="token"        # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key=""                # Your API Token or Global API Key

# Cloudflare zone and DNS record details
zone_identifier=""         # Can be found in the "Overview" tab of your domain
record_name=""             # The DNS record you want to update
...
slackuri=""                # URI for Slack WebHook (e.g., "https://hooks.slack.com/services/xxxxx")
discorduri=""              # URI for Discord WebHook (e.g., "https://discordapp.com/api/webhooks/xxxxx")
...
case "$update" in
*"\"success\":false"*)
    echo -e "DDNS Updater: $ip $record_name DDNS update failed for $record_identifier ($ip). DUMPING RESULTS:\n$update" | logger -s 
    if [[ $slackuri != "" ]]; then
